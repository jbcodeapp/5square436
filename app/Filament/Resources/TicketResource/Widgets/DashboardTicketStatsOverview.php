...
class DashboardTicketStatsOverview extends BaseWidget
{
...
//                ])
                ->color('danger'),
            Card::make('Pending Tickets', $todo+$inProgress)
                ->description('ToDo/InProgress tickets')
                ->color('warning'),
            Card::make('Under-Review', $under_review)
                ->description('Under Review tickets')
                ->color('success'),
